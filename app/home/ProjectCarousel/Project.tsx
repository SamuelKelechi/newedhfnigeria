...
const projects = [
  {
    ...
    image: "/first.png",
    para1: "During the two-week government-imposed lockdown aimed at curbing the spread of COVID-19 in Nigeria, our food bank initiative was born. Recognizing the dire need for food assistance among the already impoverished citizens, we took swift action. As an organization, we committed to feeding over 1,000 families, which translated to supporting more than 5,000 individuals during these challenging times.",
    para2: "In the face of economic hardship, widespread job loss, and the uncertainty brought on by the lockdown, we distributed essential food items that sustained many. Our efforts included providing staples such as rice, beans, noodles, and garri, etc which offered much-needed relief to those struggling to make ends meet.",
    para3: "Our outreach focused on the Ajegunle community, particularly targeting areas like Tolu Roads, JMJ Quarters, Wilmer, and Babatunde Street. By single-handedly delivering food supplies to these locations, we brought hope and stability to countless households.",
    para4: "This initiative marked the first project of our foundation since its inception. The impact of our work was profound, offering not just sustenance, but also a sense of hope and community solidarity during an unprecedented crisis.",
    para5: "Our commitment to supporting vulnerable populations continues, and we remain dedicated to making a positive difference in the lives of those in need.",
    para6: "",
    para7: "",
  },
  {
  ...
  },
  {
    ...
    subtitle: "Ajegunle Spelling Bee: Empowering Education Through Friendly Competition",
    image: "/third.png",
